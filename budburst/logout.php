...
<div id="MainContent">
    	...
    	<?php
			// Check if user is NOT logged in (they have been successfully logged out); show log out confirmation
			if(!checklogin($dbh))
			{
				//Thank you. You have been logged out and your session closed
				echo("<h1>Thank you for using Project BudBurst!</h1>
					You have been logged out. Please come back again and report more observations!</p>
					<p>&nbsp;</p>
					<p>&nbsp;</p>
					<p>&nbsp;</p>
					<p>&nbsp;</p>
