...
<div id="MainContent">
      ...
      <h1>Project BudBurst Support</h1>
      
      <h2>Sponsors</h2>
      
      <p>Project BudBurst is co-managed by the National Ecological Observatory Network, Inc. (NEON) and the Chicago Botanical Garden through a grant provided by the National Science Foundation. The success of Project BudBurst has been the result of strategic collaborations with the following institutions and organizations:</p>
      
      <center>
      <table align="center" width="100%" border="0" cellspacing="5" class="form">
                               <tr>
                  <td width="24%"><div align="center"><img src="images/nsf_web.jpg" width="142" height="143" alt="NSF Logo" /></div></td>
      ...
      <p>Project BudBurst is made possible by the generous funding from the following sponsors:</p>
      ...
      <table width="100%" border="0" cellpadding="5" class="form">
                ...
                <tr>
                  <td><div align="center"><img src="images/logo_NEON.gif" alt="NEON logo" width="100" height="37" /></div></td>
                  <td> National Ecological Observatory Network (NEON), <a href="http://www.neoninc.org/" target="_blank" class="maincontent">www.neoninc.org</a></td>
                </tr>
                <tr>
