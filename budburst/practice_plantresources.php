...
<div id="MainContent">
    ...
    <!--<img style="float:right; padding-left:12px;" src="images/AboutProjectBudBurst/Flower1.jpg" />-->
      <br/>
      <img src="images/plant_resources/plant_resrouces_ideas.jpg" width="575" height="582" hspace="75" />
 ...
 <li>Choose a plant from our <a href="pdfs/MasterPlantList.pdf">Master Plant List</a> OR</li><br/>

 <li>View<a href="plantresources_list_bystate.php"> lists of plants from your state</a> that we recommend OR</li>
    <br/>
    <li> Don't see a plant on our lists that you want to monitor? No problem! You can monitor any plant that you are interested in, even if it isn't on our lists, using our <a href="getstarted-regular-report.php">Regular Observation </a>protocol. At this time,  <a href="getstarted-single-report.php">Single Reports</a> can only be reported for Project BudBurst deciduous trees/shrubs, grasses, and wildflowers and our Special Projects species (such as Wildlife Refuge species), but we are working on making this available for other species in the near future.  <a href="pdfs/Generic-Field-Journal.pdf">Download a Generic Field Journal</a> if you are going to do Regular Observations of a species NOT on the Project BudBurst list.</li>
    </ul>
    </br>
