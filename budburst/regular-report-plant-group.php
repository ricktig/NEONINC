...
<div id="MainContent">
      ...
      <h1>Add a Plant - Select Plant Group</h1>
      ...
      <?php 
			  ...
			  if(checklogin($dbh))
			  {
                ...
                <p><strong>Select Plant Group</strong> <img src="images/breadcrumbArrow.png" style="vertical-align:middle;" /> Select Plant</p>
                <p>&nbsp;</p>
                <br />
				<form id="form1" name="form1" method="post" action="regular-report-plant.php"> <!-- register_plant.php -->
				<div style="width:550px;height:187px;margin:0 auto;background-color:#C3D9A5">
					<!--hidden inputs for passing to next page-->
					<input name="stationid" id="stationid" type="hidden" value="<?php echo $stationid;?>"/>
					<input name="personid" id="personid" type="hidden" value="<?php echo $personid;?>"/>
					...
					<div style="width:100px;margin: 5px auto 0;">
						<input name="btnsubmit" type="submit" id="btnsubmit" disabled="disabled" value="Submit" tabindex="2" />
					</div>
				</div>
</form>
                <?php
